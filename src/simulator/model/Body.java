...
public class Body {
	...
	public JSONObject getState() {
		...
		stateJSON.put("p", this.getPosition().asJSONArray());
		stateJSON.put("v", this.getVelocity().asJSONArray());
		stateJSON.put("f", this.getForce().asJSONArray());

		/*
		 * Maybe we have to do like this : TODO // we put some keys with simple values
		 * into 'jo1' jo1.put("a", 1234); jo1.put("b", 123.3e-10); jo1.put("c",
		 * "Hollaaa");
		 */
		return stateJSON;
	}
